        ...
        try {
         Map objeto = new HashMap();
            ...
            Class.forName("com.mysql.jdbc.Driver");
             Connection conexion = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/repararpc", "root", "");
...
//             JasperReport report = JasperCompileManager.compileReport("D:/Almacenamiento D/SENA 4to trimestre/JAVA/proyectos/AplicacionMensajes/src/aplicacionmensajes/reporte.jrxml");
             JasperReport report = JasperCompileManager.compileReport("./src/aplicacionmensajes/reporte.jrxml");
